...
PREVIEW_SUFFIX = "_preview.gif"  # auto-generated by cron/generate_video_previews.py
...
@flask_login.login_required
def public_content():
    s3_content = {k: v for k, v in list_files().items() if not k.endswith(PREVIEW_SUFFIX)}
